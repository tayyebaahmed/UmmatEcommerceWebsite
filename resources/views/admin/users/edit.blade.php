...
<form action="{{route('admin.profile.update', $profile->id)}}" method="POST" accept-charset="utf-8">
    @method('PATCH')
    @csrf 
    <div class="row">
	<div class="col-lg-9">
        ...
        <div class="form-group row">
			<div class="col-6">
				...
				<div class="input-group mb-3">
					...
					<input type="text" class="form-control"  name="phone" value="{{$profile->phone}}" aria-label="phone" aria-describedby="basic-addon1"/>
				</div>
			</div>
			<div class="col-6">
